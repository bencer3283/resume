...
{ \small \begin{itemize}
    \item Electronics: Arduino, ESP32, Raspberry Pi, System interface (I2C, SPI), PCB design.
...
\end{itemize}}
    ...
    \subsection*{Apprentice, Google Hardware Product Sprint, Jun. - Sep. 2024\hfill Taipei, Taiwan}
        ...
        %UX survey, mechanics design
        \begin{itemize}
            \item Lead a team of 5 to design a HasS lost and found platform for public facilities including a kiosk capable of identifying and storing lost objects and accompanying software service to help people search for their lost items.
        \end{itemize}
        }
