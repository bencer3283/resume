...
\begin{multicols}{2}
    ...
    401-432-5576 \newline
    bencer@outlook.com \newline
    \href{https://bencer3283.github.io/portfolio/}{\underline{Portfolio: https://bencer3283.github.io/portfolio/}}
...
{ \small \begin{itemize}
    ...
    \item Coding: C/C++, JavaScript (Express, React), Dart (Flutter), Python (PyTorch, NumPy), Git, Linux shell script
...
\end{itemize}}
    ...
    \subsection*{Apprentice, Google Hardware Product Sprint, Jun. - Sep. 2024\hfill Taipei, Taiwan}
        ...
        \begin{itemize}
            ...
            \item My prototypes of a microcontroller-based hardware, a mobile app and a RESTful API service drove the development direction from a single hardware product to a integrated platform.
        \end{itemize}
        }
    ...
    , https://doi.org/10.1145/3544793.3560323}
        ...
        \begin{itemize}
            \item Utilized microcontroller, potentiometers, DC motors and touch sensors to implement a shape-transforming device with a 3D tangible user interface that enabled this work to be awarded at ACM Ubicomp conference.
