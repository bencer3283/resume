...
\end{multicols}
    ...
    %\begin{multicols*}{2}
        ...
        \begin{itemize}
            ...
            \item I designed a microcontroller circuit to control a stepper motor and electromagnets, including one designed by myself. Besides, my skills in statistics with R for the UX survey, modeling with Creo and SLA/FDM prototyping were also demonstrated.
