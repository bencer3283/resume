...
\end{multicols}
    ...
    %\begin{multicols*}{2}
        ...
        \begin{itemize}
            ...
            \item My work mainly includes mechanics design with Creo, SLA prototyping and electronic circuit as well as constantly engaging New Product Introduction team in many different departments (PM, EE, ID) in the company.
        \end{itemize}
        }
